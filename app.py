...
def chain_result(pdf_d):
      ...
      prompt_template = """
        ...
        provided context specifically say, "answer is not available in the context", don't provide the wrong answer, be specific, write "WOBBA" if  if the answer is not in
        provided context  \n\n
        Context:\n {context}?\n
        Question: \n{question}\n
